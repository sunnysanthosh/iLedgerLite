...
def _days_ago(n: int) -> datetime:
    ...
    return datetime(ANCHOR_DATE.year, ANCHOR_DATE.month, ANCHOR_DATE.day, 10, 0, 0, tzinfo=timezone.utc) - timedelta(
        days=n
    )
...
# Personal Orgs (one per user): 00000000-0000-4000-0100-00000000000X
ORG_PRIYA_ID = "00000000-0000-4000-0100-000000000001"
ORG_RAJESH_ID = "00000000-0000-4000-0100-000000000002"
ORG_ANITA_ID = "00000000-0000-4000-0100-000000000003"
...
USER_ORG_MAP = {
    USER_PRIYA_ID: ORG_PRIYA_ID,
    USER_RAJESH_ID: ORG_RAJESH_ID,
    USER_ANITA_ID: ORG_ANITA_ID,
    USER_VIKRAM_ID: ORG_VIKRAM_ID,
    USER_MEENA_ID: ORG_MEENA_ID,
    USER_ARJUN_ID: ORG_ARJUN_ID,
}
...
TRANSACTIONS = [
    ...
    # Salary deposits (monthly)
    {
        "id": TXN_IDS[0],
        "user_id": USER_PRIYA_ID,
        "account_id": ACCOUNT_PRIYA_SBI_ID,
    ...
    # Freelance
    {
        ...
        "user_id": USER_PRIYA_ID,
        "account_id": ACCOUNT_PRIYA_SBI_ID,
        "category_id": CAT_FREELANCE_ID,
        "type": "income",
        "amount": Decimal("15000.00"),
        "description": "Website design project",
        "transaction_date": _days_ago(45),
    },
    {
        "id": TXN_IDS[3],
        "user_id": USER_PRIYA_ID,
        "account_id": ACCOUNT_PRIYA_CASH_ID,
        "category_id": CAT_CUSTOM_TUITION_ID,
        "type": "income",
        "amount": Decimal("5000.00"),
        "description": "Tuition classes - batch A",
        "transaction_date": _days_ago(20),
    },
    # Groceries
    {
        "id": TXN_IDS[4],
        ...
        "description": "Monthly groceries - BigBasket",
        "transaction_date": _days_ago(55),
    },
    {
        "id": TXN_IDS[5],
        "user_id": USER_PRIYA_ID,
    ...
    # Utilities
    {
        ...
        "user_id": USER_PRIYA_ID,
        "account_id": ACCOUNT_PRIYA_SBI_ID,
        "category_id": CAT_UTILITIES_ID,
        "type": "expense",
        "amount": Decimal("2500.00"),
        "description": "Electricity bill",
        "transaction_date": _days_ago(50),
    },
    # Subscriptions
    {
        "id": TXN_IDS[9],
        "user_id": USER_PRIYA_ID,
        "account_id": ACCOUNT_PRIYA_HDFC_CC_ID,
        "category_id": CAT_SUBSCRIPTION_ID,
        "type": "expense",
        "amount": Decimal("499.00"),
        "description": "Netflix subscription",
        "transaction_date": _days_ago(40),
    },
    {
        "id": TXN_IDS[10],
        "user_id": USER_PRIYA_ID,
    ...
    # Food & Dining
    {
        ...
        "user_id": USER_PRIYA_ID,
        "account_id": ACCOUNT_PRIYA_CASH_ID,
        "category_id": CAT_FOOD_DINING_ID,
        "type": "expense",
        "amount": Decimal("1200.00"),
        "description": "Dinner at Barbeque Nation",
        "transaction_date": _days_ago(15),
    },
    # Transport
    {
        "id": TXN_IDS[12],
    ...
    # Shopping
    {
        ...
        "user_id": USER_PRIYA_ID,
        "account_id": ACCOUNT_PRIYA_HDFC_CC_ID,
        "category_id": CAT_SHOPPING_ID,
        "type": "expense",
        "amount": Decimal("4500.00"),
        "description": "Amazon shopping",
        "transaction_date": _days_ago(35),
    },
    # Healthcare
    {
        "id": TXN_IDS[14],
        "user_id": USER_PRIYA_ID,
        "account_id": ACCOUNT_PRIYA_SBI_ID,
        "category_id": CAT_HEALTHCARE_ID,
        "type": "expense",
        "amount": Decimal("1500.00"),
        "description": "Doctor consultation",
        "transaction_date": _days_ago(22),
    },
    # Pet care (custom)
    {
        "id": TXN_IDS[15],
        "user_id": USER_PRIYA_ID,
        "account_id": ACCOUNT_PRIYA_CASH_ID,
        "category_id": CAT_CUSTOM_PET_CARE_ID,
        "type": "expense",
        "amount": Decimal("2000.00"),
        "description": "Vet visit for Luna",
        "transaction_date": _days_ago(18),
    },
    ...
    # Mobile
    {
        ...
        "user_id": USER_PRIYA_ID,
        "account_id": ACCOUNT_PRIYA_SBI_ID,
        "category_id": CAT_MOBILE_INTERNET_ID,
        "type": "expense",
        "amount": Decimal("599.00"),
        "description": "Jio recharge",
        "transaction_date": _days_ago(5),
    },
    # Insurance
    {
        "id": TXN_IDS[19],
        "user_id": USER_PRIYA_ID,
        "account_id": ACCOUNT_PRIYA_SBI_ID,
        "category_id": CAT_INSURANCE_ID,
        "type": "expense",
        "amount": Decimal("5000.00"),
        "description": "LIC premium",
        "transaction_date": _days_ago(3),
    },
    ...
    # Business income
    {
        "id": TXN_IDS[20],
        "user_id": USER_RAJESH_ID,
        "account_id": ACCOUNT_RAJESH_SHOP_CASH_ID,
        "category_id": CAT_CUSTOM_COUNTER_SALE_ID,
        "type": "income",
        "amount": Decimal("8500.00"),
        "description": "Daily counter sales",
        "transaction_date": _days_ago(85),
    },
    {
        "id": TXN_IDS[21],
        "user_id": USER_RAJESH_ID,
        ...
        "transaction_date": _days_ago(78),
    },
    {
        "id": TXN_IDS[22],
        "user_id": USER_RAJESH_ID,
        "account_id": ACCOUNT_RAJESH_ICICI_ID,
        "category_id": CAT_CUSTOM_WHOLESALE_ID,
        "type": "income",
        "amount": Decimal("45000.00"),
        "description": "Wholesale order - Suresh Textiles",
        "transaction_date": _days_ago(70),
    },
    {
        "id": TXN_IDS[23],
        "user_id": USER_RAJESH_ID,
        ...
        "description": "Wholesale order - Lakshmi Stores",
        "transaction_date": _days_ago(55),
    },
    {
        "id": TXN_IDS[24],
        ...
        "description": "Counter sales - festive week",
        "transaction_date": _days_ago(42),
    },
    {
        "id": TXN_IDS[25],
        "user_id": USER_RAJESH_ID,
        "account_id": ACCOUNT_RAJESH_PAYTM_ID,
        "category_id": CAT_BUSINESS_INCOME_ID,
        "type": "income",
        "amount": Decimal("6000.00"),
        "description": "UPI payments collected",
        "transaction_date": _days_ago(30),
    },
    {
        "id": TXN_IDS[26],
        ...
        "description": "Wholesale order - Mohammed Traders",
        "transaction_date": _days_ago(20),
    },
    # Supplier payments
    {
        ...
        "user_id": USER_RAJESH_ID,
        "account_id": ACCOUNT_RAJESH_ICICI_ID,
        "category_id": CAT_SUPPLIER_PAYMENT_ID,
        "type": "expense",
        "amount": Decimal("35000.00"),
        "description": "Supplier - Mumbai Fabrics",
        "transaction_date": _days_ago(65),
    },
    {
        "id": TXN_IDS[28],
        "user_id": USER_RAJESH_ID,
        ...
        "description": "Supplier - Surat Silk House",
        "transaction_date": _days_ago(40),
    },
    # Salary expense
    {
        ...
        "user_id": USER_RAJESH_ID,
        "account_id": ACCOUNT_RAJESH_ICICI_ID,
        "category_id": CAT_SALARY_EXPENSE_ID,
        "type": "expense",
        "amount": Decimal("15000.00"),
        "description": "Staff salary - Ramu",
        "transaction_date": _days_ago(30),
    },
    {
        "id": TXN_IDS[30],
    ...
    },
    {
        ...
        "type": "expense",
        "amount": Decimal("25000.00"),
        "description": "Shop rent - February",
        "transaction_date": _days_ago(30),
    },
    # Packaging (custom)
    {
        ...
        "user_id": USER_RAJESH_ID,
        "account_id": ACCOUNT_RAJESH_SHOP_CASH_ID,
        "category_id": CAT_CUSTOM_PACKAGING_ID,
        "type": "expense",
        "amount": Decimal("3500.00"),
    ...
    # Maintenance
    {
        ...
        "user_id": USER_RAJESH_ID,
        "account_id": ACCOUNT_RAJESH_SHOP_CASH_ID,
        "category_id": CAT_MAINTENANCE_ID,
        "type": "expense",
        "amount": Decimal("2000.00"),
    ...
    # Catering income
    {
        "id": TXN_IDS[38],
        "user_id": USER_ANITA_ID,
        "account_id": ACCOUNT_ANITA_KOTAK_ID,
        "category_id": CAT_CUSTOM_CATERING_ID,
        "type": "income",
        "amount": Decimal("25000.00"),
        "description": "Wedding catering - Sharma family",
        "transaction_date": _days_ago(80),
    },
    {
        "id": TXN_IDS[39],
        "user_id": USER_ANITA_ID,
    ...
    },
    {
        "id": TXN_IDS[40],
        "user_id": USER_ANITA_ID,
        "account_id": ACCOUNT_ANITA_CASH_ID,
        "category_id": CAT_CUSTOM_COMMISSION_ID,
        "type": "income",
    ...
    # Kitchen supplies (custom)
    {
        ...
        "user_id": USER_ANITA_ID,
        "account_id": ACCOUNT_ANITA_CASH_ID,
        "category_id": CAT_CUSTOM_KITCHEN_ID,
        "type": "expense",
        "amount": Decimal("8000.00"),
        "description": "Bulk spices & ingredients",
        "transaction_date": _days_ago(75),
    },
    {
        "id": TXN_IDS[43],
        "user_id": USER_ANITA_ID,
    ...
    # Loan EMI
    {
        ...
        "user_id": USER_ANITA_ID,
        "account_id": ACCOUNT_ANITA_KOTAK_ID,
        "category_id": CAT_EMI_LOAN_ID,
        "type": "expense",
        "amount": Decimal("22000.00"),
        "description": "Home loan EMI - Jan",
        "transaction_date": _days_ago(60),
    },
    {
        "id": TXN_IDS[45],
    ...
    # Salary expense (staff)
    {
        ...
        "type": "expense",
        "amount": Decimal("10000.00"),
        "description": "Kitchen helper salary",
        "transaction_date": _days_ago(30),
    },
    # Utilities
    {
        ...
        "type": "expense",
        "amount": Decimal("3500.00"),
        "description": "Gas cylinder + electricity",
        "transaction_date": _days_ago(20),
    },
    # Transfer
    {
        ...
        "type": "transfer",
        "amount": Decimal("5000.00"),
        "description": "Business to personal cash",
        "transaction_date": _days_ago(10),
    },
    # ===== Vikram (U4): 3 transactions (not onboarded, minimal) =====
    {
        "id": TXN_IDS[50],
        "user_id": USER_VIKRAM_ID,
        "account_id": ACCOUNT_VIKRAM_CASH_ID,
        "category_id": CAT_OTHER_INCOME_ID,
        "type": "income",
        "amount": Decimal("5000.00"),
        "description": "Cash gift from uncle",
        "transaction_date": _days_ago(30),
    },
    {
        "id": TXN_IDS[51],
    ...
    # ===== Meena (U5): 2 transactions (inactive user, historical) =====
    {
        "id": TXN_IDS[53],
        "user_id": USER_MEENA_ID,
        "account_id": ACCOUNT_MEENA_BANK_ID,
        "category_id": CAT_SALARY_ID,
        "type": "income",
        "amount": Decimal("30000.00"),
        "description": "Last salary before deactivation",
        "transaction_date": _days_ago(90),
    },
    {
        "id": TXN_IDS[54],
        "user_id": USER_MEENA_ID,
        ...
        "type": "expense",
        "amount": Decimal("10000.00"),
        "description": "Last rent payment",
        "transaction_date": _days_ago(88),
    },
]
...
CUSTOMERS = [
    # Rajesh's customers
    {
        "id": CUST_SURESH_TEXTILES_ID,
        "user_id": USER_RAJESH_ID,
        "name": "Suresh Textiles",
        "phone": "+919800100001",
        "email": "suresh.textiles@example.com",
        "address": "12 Cloth Market, Ahmedabad",
    },
    {
        "id": CUST_LAKSHMI_STORES_ID,
        "user_id": USER_RAJESH_ID,
        "name": "Lakshmi Stores",
        "phone": "+919800100002",
        "email": "lakshmi.stores@example.com",
        "address": "45 MG Road, Pune",
    },
    {
        "id": CUST_MOHAMMED_TRADERS_ID,
        "user_id": USER_RAJESH_ID,
        "name": "Mohammed Traders",
        "phone": "+919800100003",
        "email": None,
        "address": "78 Station Road, Mumbai",
    },
    {
        "id": CUST_DEEPA_FASHIONS_ID,
        "user_id": USER_RAJESH_ID,
        "name": "Deepa Fashions",
        "phone": "+919800100004",
        "email": "deepa.fashions@example.com",
        "address": None,
    },
    # Anita's customers
    {
        "id": CUST_RAMESH_SWEETS_ID,
        "user_id": USER_ANITA_ID,
        "name": "Ramesh Sweets & Snacks",
        "phone": "+919800200001",
        "email": "ramesh.sweets@example.com",
        "address": "22 Food Street, Chennai",
    },
    {
        "id": CUST_KAVITHA_FLOWERS_ID,
        "user_id": USER_ANITA_ID,
        "name": "Kavitha Flower Decorations",
        "phone": "+919800200002",
        "email": None,
        "address": "9 Temple Road, Coimbatore",
    },
    {
        "id": CUST_PRAKASH_HARDWARE_ID,
        "user_id": USER_ANITA_ID,
        "name": "Prakash Hardware",
        "phone": "+919800200003",
        "email": "prakash.hw@example.com",
        "address": "56 Industrial Area, Bangalore",
    },
    {
        "id": CUST_SUNITA_DAIRY_ID,
        "user_id": USER_ANITA_ID,
        "name": "Sunita Dairy Farm",
        "phone": "+919800200004",
        "email": "sunita.dairy@example.com",
        "address": None,
    },
]
...
LEDGER_ENTRIES = [
    ...
    },
    {
        ...
        "type": "credit",
        "amount": Decimal("15000.00"),
        "description": "Payment received - #101",
        "due_date": None,
        "is_settled": True,
    },
    {
        ...
        "type": "debit",
        "amount": Decimal("25000.00"),
        "description": "Fabric order #102",
        "due_date": _date_ago(5),
        "is_settled": False,
    },  # OVERDUE
    {
        "id": LEDGER_IDS[3],
        ...
        "type": "credit",
        "amount": Decimal("10000.00"),
        "description": "Partial payment - #102",
        "due_date": None,
        "is_settled": False,
    },
    {
        ...
        "type": "debit",
        "amount": Decimal("8000.00"),
        "description": "Fabric order #103",
        "due_date": _date_ahead(15),
        "is_settled": False,
    },  # Future due date
    ...
    # ===== Rajesh -> Lakshmi Stores (4 entries) =====
    {
        "id": LEDGER_IDS[5],
        "user_id": USER_RAJESH_ID,
        "customer_id": CUST_LAKSHMI_STORES_ID,
        "type": "debit",
        "amount": Decimal("12000.00"),
        "description": "Saree lot #50",
    ...
    # ===== Rajesh -> Mohammed Traders (3 entries) =====
    {
        "id": LEDGER_IDS[9],
        "user_id": USER_RAJESH_ID,
        "customer_id": CUST_MOHAMMED_TRADERS_ID,
        "type": "debit",
        "amount": Decimal("20000.00"),
        "description": "Bulk cotton order",
        "due_date": _date_ago(10),
        "is_settled": True,
    },
    {
        "id": LEDGER_IDS[10],
    ...
    },
    {
        ...
        "type": "debit",
        "amount": Decimal("18000.00"),
        "description": "New silk order",
        "due_date": _date_ahead(30),
        "is_settled": False,
    },
    ...
    # ===== Rajesh -> Deepa Fashions (2 entries) =====
    {
        "id": LEDGER_IDS[12],
        "user_id": USER_RAJESH_ID,
        "customer_id": CUST_DEEPA_FASHIONS_ID,
        "type": "debit",
        "amount": Decimal("7500.00"),
        "description": "Designer collection",
        "due_date": _date_ago(3),
        "is_settled": False,
    },  # OVERDUE
    {
        "id": LEDGER_IDS[13],
    ...
    # ===== Anita -> Ramesh Sweets (3 entries) =====
    {
        "id": LEDGER_IDS[14],
        "user_id": USER_ANITA_ID,
        "customer_id": CUST_RAMESH_SWEETS_ID,
        "type": "debit",
        "amount": Decimal("15000.00"),
        "description": "Diwali sweets catering",
        "due_date": _date_ago(20),
        "is_settled": True,
    },
    {
        "id": LEDGER_IDS[15],
    ...
    },
    {
        ...
        "type": "debit",
        "amount": Decimal("10000.00"),
        "description": "Republic Day order",
        "due_date": _date_ahead(5),
        "is_settled": False,
    },
    ...
    # ===== Anita -> Kavitha Flowers (3 entries) =====
    {
        "id": LEDGER_IDS[17],
        "user_id": USER_ANITA_ID,
        "customer_id": CUST_KAVITHA_FLOWERS_ID,
        "type": "debit",
        "amount": Decimal("8000.00"),
        "description": "Flower decoration supply",
        "due_date": _date_ago(7),
        "is_settled": False,
    },  # OVERDUE
    {
        "id": LEDGER_IDS[18],
    ...
    },
    {
        ...
        "type": "debit",
        "amount": Decimal("5000.00"),
        "description": "Temple event flowers",
        "due_date": _date_ahead(20),
        "is_settled": False,
    },
    ...
    # ===== Anita -> Prakash Hardware (3 entries) =====
    {
        "id": LEDGER_IDS[20],
        "user_id": USER_ANITA_ID,
        "customer_id": CUST_PRAKASH_HARDWARE_ID,
        "type": "debit",
        "amount": Decimal("12000.00"),
        "description": "Kitchen renovation supplies",
        "due_date": _date_ago(40),
        "is_settled": True,
    },
    {
        "id": LEDGER_IDS[21],
    ...
    },
    {
        ...
        "type": "debit",
        "amount": Decimal("6000.00"),
        "description": "Utensils order",
        "due_date": _date_ahead(25),
        "is_settled": False,
    },
    ...
    # ===== Anita -> Sunita Dairy (2 entries) =====
    {
        "id": LEDGER_IDS[23],
        "user_id": USER_ANITA_ID,
        "customer_id": CUST_SUNITA_DAIRY_ID,
        "type": "debit",
        "amount": Decimal("4500.00"),
        "description": "Monthly milk supply",
        "due_date": _date_ago(2),
        "is_settled": False,
    },  # OVERDUE
    {
        "id": LEDGER_IDS[24],
...
RECEIPTS = [
    {
        ...
        "file_url": "/receipts/priya_groceries_001.jpg",
        "ocr_text": "BigBasket Invoice #BB2024001 Total: Rs 3,500.00",
    },
    {
        "id": RECEIPT_IDS[1],
        "transaction_id": TXN_IDS[6],
        "file_url": "/receipts/priya_rent_jan.pdf",
        "ocr_text": "Rent Receipt January 2024 Amount: Rs 18,000",
    },
    {
        "id": RECEIPT_IDS[2],
        "transaction_id": TXN_IDS[27],
        "file_url": "/receipts/rajesh_supplier_mumbai.jpg",
        "ocr_text": "Mumbai Fabrics Tax Invoice GST: 18% Total: Rs 35,000.00",
    },
    {
        "id": RECEIPT_IDS[3],
        "transaction_id": TXN_IDS[38],
        "file_url": "/receipts/anita_catering_sharma.pdf",
        "ocr_text": "Catering Invoice - Sharma Wedding 250 guests Total: Rs 25,000",
    },
    {
        "id": RECEIPT_IDS[4],
        "transaction_id": TXN_IDS[44],
        "file_url": "/receipts/anita_emi_jan.pdf",
        "ocr_text": "Home Loan EMI Receipt Bank: Kotak EMI: Rs 22,000.00",
    },
]
...
def get_overdue_entries() -> list[dict]:
    ...
    today = ANCHOR_DATE
    return [e for e in LEDGER_ENTRIES if not e["is_settled"] and e["due_date"] is not None and e["due_date"] < today]
...
def make_auth_headers(user_id: str, secret: str = JWT_SECRET, org_id: str | None = None) -> dict[str, str]:
    """Create Authorization headers for a user, optionally including X-Org-ID."""
...
# Convenient per-user header factories (include personal org X-Org-ID)
